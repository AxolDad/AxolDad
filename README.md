...
- **Decades as a logistician** before software: the United States Air Force (Logistics Management Specialist, Security Forces, and Chemical Warfare Survival Instructor), local and regional disaster response, the American Red Cross, and multiple private organizations. [xin.bz](https://xin.bz) is that experience turned into a product.
